  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <input
          {...props}
          className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-[#2a2a2a] bg-secondary text-white placeholder:text-white/25 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary text-sm transition-colors"
        />
      </div>
    </div>
  )
